import 'package:flutter_distini/main.dart';
...
//TODO: Step 16 - Create a property called storyBrain which starts with a value of 0. This will be used to track which story the user is currently viewing.
  int storyNumber = 0;

  void nextStory(int choiceNumber) {
    if (storyNumber == 4 || storyNumber == 5 || storyNumber == 3) {
      restart();
    } else {
      if (storyNumber == 0) {
        if (choiceNumber == 1) {
